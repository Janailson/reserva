<%@ Page Title="Churrasqueira 1 - Reserva - Condomínio Felicittá" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="churrasqueira1.aspx.cs" Inherits="reserva.churrasqueira1" %>
        ...
        function makeCalendar() {
            ...
            $('.calendar').fullCalendar({
                ...
                dayClick: function (date, jsEvent, view, resourceObj) {
                    json = Ajax.Churrasqueira1.Consultar(date);
                    if (json["error"]) {
                        if (json["code"] != "10") {
                            alert(json["message"]);
                            return;
                        ...
                        json = Ajax.Churrasqueira1.Cancelar(date);
                        if (json["error"]) {
                            alert(json["message"]);
                            return;
                        }
                    ...
                    json = Ajax.Churrasqueira1.Reservar(date);
                    if (json["error"]) {
                        alert(json["message"]);
                        return;
                    }
                ...
                editable: false,
                droppable: false,
                events: Ajax.Churrasqueira1.Listar()
            });
        }
    </script>
</asp:Content>
