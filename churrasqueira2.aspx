<%@ Page Title="Churrasqueira 2 - Reserva - Condomínio Felicittá" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="churrasqueira2.aspx.cs" Inherits="reserva.churrasqueira2" %>
        ...
        function makeCalendar() {
            ...
            $('.calendar').fullCalendar({
                ...
                dayClick: function (date, jsEvent, view, resourceObj) {
                    json = Ajax.Churrasqueira2.Consultar(date);
                    if (json["error"]) {
                        if (json["code"] != "10") {
                            alert(json["message"]);
                            return;
                        ...
                        json = Ajax.Churrasqueira2.Cancelar(date);
                        if (json["error"]) {
                            alert(json["message"]);
                            return;
                        }
                    ...
                    json = Ajax.Churrasqueira2.Reservar(date);
                    if (json["error"]) {
                        alert(json["message"]);
                        return;
                    }
                ...
                editable: false,
                droppable: false,
                events: Ajax.Churrasqueira2.Listar()
            });
        }
    </script>
</asp:Content>
